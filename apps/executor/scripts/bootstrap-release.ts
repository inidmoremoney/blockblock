...
async function main(): Promise<void> {
  ...
  tx1.transferObjects([profile as unknown as TransactionResult], sender);
  ...
  tx2.transferObjects([root as unknown as TransactionResult], sender);
  ...
  tx3.moveCall({
    ...
    arguments: [release as unknown as TransactionResult],
  });
  tx3.moveCall({
