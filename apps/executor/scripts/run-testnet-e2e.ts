...
async function main(): Promise<void> {
  ...
  if (receipt === undefined) {
    ...
    // Testnet's fullnode index lags object creation by a couple seconds;
    // referencing this object in the next transaction immediately after
    // creating it intermittently 404s without this.
